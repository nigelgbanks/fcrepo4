...
public abstract class JcrRdfTools {
    ...
    public static final String HAS_NAMESPACE_PREDICATE =
        "info:fedora/fedora-system:def/internal#hasNamespace";
    ...
    public static Model getJcrNamespaceModel(final Session session)
        ...
        for (Map.Entry<String, String> entry : prefixMap.entrySet()) {
            ...
            model.add(ResourceFactory.createResource(entry.getValue()),
                      ResourceFactory.createProperty(HAS_NAMESPACE_PREDICATE),
    ...
    private static void addRepositoryMetricsToModel(final GraphSubjects factory,
        ...
        for (final String key : repository.getDescriptorKeys()) {
            ...
            if (descriptor != null) {
                String uri =
                    "info:fedora/fedora-system:def/internal#repository/" + key;
                model.add(subject,
                          model.createProperty(uri), descriptor);
            }
        }
        ...
        while (nodeTypes.hasNext()) {
            ...
            model.add(
                      subject,
                      model.createProperty("info:fedora/fedora-system:def/" +
                                           "internal#hasNodeType"),
                      nodeType.getName());
        }
        model.add(
                  subject,
                  model.createProperty("info:fedora/fedora-system:def/internal#" +
                                       "objectCount"),
                  ResourceFactory
    ...
    public static Model getFixityResultsModel(final GraphSubjects factory,
        ...
        for ( FixityResult result : blobs) {
            ...
            model.add(resultSubject,
                      ResourceFactory.createProperty("info:fedora/" +
                                                     "fedora-system:def/" +
                                                     "internal" +
                                                     "#isFixityResultOf"),
            ...
            model.add(resultSubject,
                      ResourceFactory.createProperty("info:fedora/" +
                                                     ...
                                                     "#computedChecksum"),
                      ResourceFactory
                      .createResource(result.computedChecksum.toString()));
            model.add(resultSubject,
                      ResourceFactory.createProperty("info:fedora/" +
                                                     "fedora-system:def/" +
